...
def resumo (preco=0, taxaa=10, taxarr=5) -> object:
    print('-' * 30)
    ...
    print(f'Com {taxaa} % de aumento: \t{aumenta(preco,taxaa, True)}')
    print(f'Com {taxarr} % de redução : \t {diminuir(preco,taxarr,True)} ')